...
place_up = ([0,25,25,0,90,90])
place_down = ([0,25,15,0,90,90])
...
while catch_count < max_catch_count:
    ...
    # robot.move_joints(-0.0068165681880558715, 0.022201033196341702, -0.24317924751069953, -0.04746075083466206, -1.9160346576589586, -0.002975307985978226)
    robot.move_pose(pos)
